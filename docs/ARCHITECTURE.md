...
if cfg.MinimaxWebTokens != ""   { registry.Register(provider.NewMinimax(cfg)) }    // 直连
```
...
| MiniMax | `MINIMAX_WEB_TOKENS`(直连) | `MINIMAX_MODELS` | `MINIMAX_AGENT_ID`/`MINIMAX_DEVICE_ID`/`MINIMAX_USER_ID`(账号级参数,见 docs/MINIMAX.md) |
