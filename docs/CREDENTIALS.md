...
| **DeepSeek** | userToken(localStorage) | `deepseek_tokens.txt` | 会话级(实测稳定) | **不在 harvester 范围**(2026-09-05 实测:NUC Chrome 的 deepseek localStorage userToken 为无效游客票,上游 invalid token;有效票 64B 人工管理)。失效手动重抓 |
