// scripts/cdp/minimax-checkin.mjs — MiniMax 每日签到(纯 Node,无浏览器依赖)
//
...
//
// 由 keepalive-daily.ps1 每天调用(任务计划 aurora-cdp-keepalive 每天 08:30 触发)。
...
const TOKEN_FILE = process.argv[2] || "D:/repos/aurora/.runtime/tokens/minimax_tokens.txt";
